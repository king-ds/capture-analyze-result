                    ...
                    case 0:
                        ...
                        if (isHealthy.equals("Healthy")) {
                            ...
                            if(disorder.equals("Beau Lines")){
                                ...
                                beau_intent.putExtra("isAnswered", resultp.get(HistoryActivity.ISANSWERED));
                                beau_intent.putExtra("answer_1", resultp.get(HistoryActivity.ANSWER_1));
                                beau_intent.putExtra("answer_2", resultp.get(HistoryActivity.ANSWER_2));
                                beau_intent.putExtra("answer_3", resultp.get(HistoryActivity.ANSWER_3));
                                beau_intent.putExtra("answer_4", resultp.get(HistoryActivity.ANSWER_4));
                                beau_intent.putExtra("answer_5", resultp.get(HistoryActivity.ANSWER_5));
                                beau_intent.putExtra("answer_6", resultp.get(HistoryActivity.ANSWER_6));
                                beau_intent.putExtra("answer_7", resultp.get(HistoryActivity.ANSWER_7));
                                beau_intent.putExtra("answer_8", resultp.get(HistoryActivity.ANSWER_8));
                                image.buildDrawingCache();
                                Bitmap bitmap = image.getDrawingCache();
                                ...
                                club_intent.putExtra("isAnswered", resultp.get(HistoryActivity.ISANSWERED));
                                club_intent.putExtra("answer_1", resultp.get(HistoryActivity.ANSWER_1));
                                club_intent.putExtra("answer_2", resultp.get(HistoryActivity.ANSWER_2));
                                club_intent.putExtra("answer_3", resultp.get(HistoryActivity.ANSWER_3));
                                club_intent.putExtra("answer_4", resultp.get(HistoryActivity.ANSWER_4));
                                club_intent.putExtra("answer_5", resultp.get(HistoryActivity.ANSWER_5));
                                club_intent.putExtra("answer_6", resultp.get(HistoryActivity.ANSWER_6));
                                club_intent.putExtra("answer_7", resultp.get(HistoryActivity.ANSWER_7));
                                image.buildDrawingCache();
                                Bitmap bitmap = image.getDrawingCache();
                                ...
                                spoon_intent.putExtra("isAnswered", resultp.get(HistoryActivity.ISANSWERED));
                                spoon_intent.putExtra("answer_1", resultp.get(HistoryActivity.ANSWER_1));
                                spoon_intent.putExtra("answer_2", resultp.get(HistoryActivity.ANSWER_2));
                                spoon_intent.putExtra("answer_3", resultp.get(HistoryActivity.ANSWER_3));
                                spoon_intent.putExtra("answer_4", resultp.get(HistoryActivity.ANSWER_4));
                                spoon_intent.putExtra("answer_5", resultp.get(HistoryActivity.ANSWER_5));
                                spoon_intent.putExtra("answer_6", resultp.get(HistoryActivity.ANSWER_6));
                                spoon_intent.putExtra("answer_7", resultp.get(HistoryActivity.ANSWER_7));
                                spoon_intent.putExtra("answer_8", resultp.get(HistoryActivity.ANSWER_8));
                                image.buildDrawingCache();
                                Bitmap bitmap = image.getDrawingCache();
                                ...
                                terrys_intent.putExtra("isAnswered", resultp.get(HistoryActivity.ISANSWERED));
                                terrys_intent.putExtra("answer_1", resultp.get(HistoryActivity.ANSWER_1));
                                terrys_intent.putExtra("answer_2", resultp.get(HistoryActivity.ANSWER_2));
                                terrys_intent.putExtra("answer_3", resultp.get(HistoryActivity.ANSWER_3));
                                terrys_intent.putExtra("answer_4", resultp.get(HistoryActivity.ANSWER_4));
                                terrys_intent.putExtra("answer_5", resultp.get(HistoryActivity.ANSWER_5));
                                terrys_intent.putExtra("answer_6", resultp.get(HistoryActivity.ANSWER_6));
                                terrys_intent.putExtra("answer_7", resultp.get(HistoryActivity.ANSWER_7));
                                image.buildDrawingCache();
                                Bitmap bitmap = image.getDrawingCache();
                                ...
                                yellow_intent.putExtra("isAnswered", resultp.get(HistoryActivity.ISANSWERED));
                                yellow_intent.putExtra("answer_1", resultp.get(HistoryActivity.ANSWER_1));
                                yellow_intent.putExtra("answer_2", resultp.get(HistoryActivity.ANSWER_2));
                                yellow_intent.putExtra("answer_3", resultp.get(HistoryActivity.ANSWER_3));
                                yellow_intent.putExtra("answer_4", resultp.get(HistoryActivity.ANSWER_4));
                                yellow_intent.putExtra("answer_5", resultp.get(HistoryActivity.ANSWER_5));
                                yellow_intent.putExtra("answer_6", resultp.get(HistoryActivity.ANSWER_6));
                                yellow_intent.putExtra("answer_7", resultp.get(HistoryActivity.ANSWER_7));
                                yellow_intent.putExtra("answer_8", resultp.get(HistoryActivity.ANSWER_8));
                                yellow_intent.putExtra("answer_9", resultp.get(HistoryActivity.ANSWER_9));
                                image.buildDrawingCache();
                                Bitmap bitmap = image.getDrawingCache();
